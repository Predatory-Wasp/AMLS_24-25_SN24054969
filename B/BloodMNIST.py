...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=16):
        ...
        self.fc1 = nn.Conv2d(in_planes, in_planes // ratio, 1, bias=False)  # Dimension reduction, decrease the number of channels
        self.relu1 = nn.ReLU()  
        self.fc2 = nn.Conv2d(in_planes // ratio, in_planes, 1, bias=False)  # Dimension increase, restore the original number of channels
